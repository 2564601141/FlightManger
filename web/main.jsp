...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />航班管理中心</h1>
    </div>
...
<div class="leftnav">
    ...
    <h2><span class="icon-pencil-square-o"></span>航班管理</h2>
    <ul>
    <%--此处跳转到查询，执行查询操作servlet--%>
        <li><a href="${pageContext.request.contextPath}/list.jsp" target="right"><span class="icon-caret-right"></span>查询航班列表</a></li>
    </ul>
</div>
